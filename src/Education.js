...
const Education = () => {
    ...
    const courses = [
      ...
      {
        "id": 11,
        "title": "Parallel and Sequential Data Structures and Algorithms (Spring 2022)",
        "description": "Teaches methods for designing, analyzing, and programming sequential and parallel algorithms and data structures with a focus on parallelism. The emphasis is on teaching fundamental concepts applicable across a wide variety of problem domains, and transferable across a reasonably broad set of programming languages and computer architectures.",
        "skills": "SML/NJ, asymptotic analysis, parallel algorithms, graph algorithms, randomized algorithms, parallel data structures"
      },
      {
        "id": 1,
      ...
      {
        "id": 12,
        "title": "Application Design and Development (Spring 2022)",
        "description": "Teaches how to design and create relational databases, how to acquire competency in new programming languages quickly, how to use the Model-View-Controller pattern to develop software applications, how to ensure technical quality in software development, and how to apply principles of user-centered design.",
        "skills": "Ruby on Rails, MVC design pattern, user-centered design"
      },
      {
        "id": 2,
      ...
      {
        "id": 13,
        "title": "Interaction Design Overview (Spring 2022)",
        "description": "This studio course offers a broad overview of communication and interaction design. Students will learn design methodologies such as brainstorming, sketching, storyboarding, wire framing, and prototyping. Students learn to take a human-centered design approach to their work.",
        "skills": "Design methodologies, team- and self-critique, development of professional-grade process books"
      },
      {
        "id": 3,
                ...
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            ...
                            <div>Editor in Chief of the Hillsborough Esthetic Literary Magazine</div>
