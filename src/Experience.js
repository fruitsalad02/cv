                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            ...
                            <ul>
                                ...
                                <li>Worked with the product development team to write business requirement documents and participated in product function review and feature testing using an agile project management framework</li>
                                <li>Designed consolidated master templates for customer lead management and analysis using Excel and R</li>
                                <li>Prepared and presented a PowerPoint to the executive team at internship conclusion</li>
                            </ul>
                        </div>
